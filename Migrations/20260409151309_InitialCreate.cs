        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TemAlmoco = table.Column<bool>(type: "INTEGER", nullable: false),
                    DuracaoAlmoco = table.Column<int>(type: "INTEGER", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ObservacaoBloqueio = table.Column<string>(type: "TEXT", nullable: false),
                    AgendaId = table.Column<int>(type: "INTEGER", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_HorariosAgenda", x => x.Id);
                    table.ForeignKey(
                        name: "FK_HorariosAgenda_Agendas_AgendaId",
                        column: x => x.AgendaId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Agendamentos_HorariosAgenda_HorarioId",
                        column: x => x.HorarioId,
                        principalTable: "HorariosAgenda",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_HorariosAgenda_AgendaId",
                table: "HorariosAgenda",
                column: "AgendaId");
        }
